...
```bash
curl -fsSL https://raw.githubusercontent.com/tickernelz/hermes-stack-bootstrap/v0.1.15/install.sh | bash
```

Dry-run first if you want a safe preview:

```bash
curl -fsSL https://raw.githubusercontent.com/tickernelz/hermes-stack-bootstrap/v0.1.15/install.sh | bash -s -- --dry-run
```

Inspect before running:

```bash
curl -fsSLO https://raw.githubusercontent.com/tickernelz/hermes-stack-bootstrap/v0.1.15/install.sh
less install.sh
